...
const StartupSection = () => {
  ...
  const fullText = `Startups bring innovation and new ideas to life, but many face difficulties with funding, scaling, and keeping early supporters engaged.\nTraditional investment structures can be slow and exclusive, leaving little room for community participation.\nTokenization changes this by allowing equity, rewards, or milestones to be shared as digital tokens, making fundraising faster and more inclusive.\nOur company's aim is to tokenize startup growth milestones and equity, giving early supporters real value while helping founders grow transparently.`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 order-1 lg:order-2 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Empowering Startups with Token Incentives
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              Startups face challenges with funding, transparency, and scaling. Tokenization gives supporters real value while helping startups grow. We create tokens for startup equity and milestones, giving early supporters a stake and helping founders scale with community support.
            </p>
