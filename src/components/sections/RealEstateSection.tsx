...
const RealEstateSection = () => {
  ...
  const fullText = `Real estate has always been a reliable way to build wealth, but buying property usually requires large capital and involves slow, complicated processes.\nThis creates barriers for smaller investors and limits liquidity in the market.\nTokenization solves this by splitting property ownership into smaller, digital shares that are easier to trade.\nOur mission is to tokenize real estate assets so landlords and investors can access liquidity, diversify portfolios, and make property investment more inclusive.`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 order-1 lg:order-2 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Unlocking Real Estate with Tokenization
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              Real estate is a stable investment but can be expensive and hard to trade. Tokenization breaks properties into smaller, tradeable digital shares. We tokenize real estate, making it easier for landlords and investors to trade property shares, unlock liquidity, and open opportunities to more people.
            </p>
