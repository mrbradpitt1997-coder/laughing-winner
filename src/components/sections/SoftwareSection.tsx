...
const SoftwareSection = () => {
  ...
  const fullText = `Automation helps businesses work faster and smarter by handling repetitive tasks. It reduces costs and allows brands to scale efficiently.\nThe problem is, it's often unclear how to measure the value created and how to reward different contributors in an automated system.\nBy tokenizing performance data and reward flows, businesses can track contributions transparently and distribute incentives more fairly.\nOur goal is to tokenize operational metrics, so companies can build more efficient, data-driven reward systems for both people and machines.`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 order-1 lg:order-2 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Rewarding Efficiency Through Automation
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              Automation saves time, reduces costs, and improves efficiency, but tracking value contribution is difficult. Tokenization allows companies to measure performance and give clear digital rewards. We create tokens for automated operations, helping businesses build transparent systems that benefit employees and customers alike.
            </p>
