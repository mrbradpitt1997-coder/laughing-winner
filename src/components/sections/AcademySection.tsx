...
const AcademySection = () => {
  ...
  const fullText = `Education is no longer limited to classrooms—it's happening online, through micro-courses, and even community learning. The challenge is that it's hard to verify achievements, reward contributions fairly, and motivate learners over time. With tokenization, achievements like completed courses or valuable contributions can become digital credentials or reward tokens. These can be stored securely, verified instantly, and even used to unlock new opportunities. Our company plans to tokenize academic milestones, creating a fair and transparent reward system for both learners and educators.`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 order-1 lg:order-2 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Rewarding Learning with Tokens
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              Education is changing with online courses and micro-credentials, but rewarding learners and teachers fairly is still a challenge. Tokenization allows participants to earn value for their achievements. We create tokens for academic milestones, making it easy to reward learning and teaching while encouraging participation in education ecosystems.
            </p>
