...
const CrowdFSection = () => {
  ...
  const fullText = `Краудфандинг открыл возможности для многих творческих проектов и стартапов, позволяя людям инвестировать в идеи, которые им близки.\nОднако традиционный краудфандинг часто негибкий — у инвесторов мало ликвидности и ограниченный контроль после вложения.\nТокенизация позволяет представить такие инвестиции в виде цифровых токенов, которыми проще торговать, отслеживать и управлять.\nМы планируем токенизировать краудфандинговые активы, чтобы сторонники могли гибко хранить, обменивать или увеличивать свои инвестиции, а проекты получали долгосрочную поддержку.`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Краудфандинг становится гибче с токенами
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              Краудфандинг позволяет сообществам поддерживать проекты, но традиционные методы лишены ликвидности и гибкости. Токенизация превращает инвестиции в цифровые активы, которые можно отслеживать и обменивать. Наша компания создаёт токены для краудфандинговых проектов, давая инвесторам больше гибкости и долгосрочных возможностей.
            </p>
