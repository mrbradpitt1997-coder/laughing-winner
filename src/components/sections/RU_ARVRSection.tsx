...
const ARVRSection = () => {
  ...
  const fullText = `Дополненная реальность (AR) и виртуальная реальность (VR) открывают новые способы взаимодействия с цифровым миром — через игры, обучение, покупки и многое другое.\nОднако удерживать внимание пользователей и вознаграждать создателей всё ещё сложно, ведь большая часть ценности остаётся у владельцев платформ.\nТокенизация позволяет превращать внутриигровые активы, действия пользователей и творческий контент в токены, обладающие реальной ценностью. Это стимулирует более глубокое участие и долгосрочный рост виртуальных пространств.\nМы стремимся токенизировать вовлечённость и награды внутри AR/VR-экосистем, чтобы и пользователи, и создатели получали свою долю ценности.`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Превращаем цифровой опыт в ценность
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              AR и VR создают захватывающие возможности для игр, покупок и обучения. Однако вознаграждать пользователей за активность бывает непросто. Токенизация позволяет превращать участие и создание контента в цифровые активы. Мы фокусируемся на токенизации AR/VR-активностей, чтобы пользователи получали ценность и помогали развитию экосистемы.
            </p>
