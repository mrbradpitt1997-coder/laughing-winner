...
const StartupSection = () => {
  ...
  const fullText = `Стартапы воплощают инновации и новые идеи, но многие сталкиваются с трудностями в финансировании, масштабировании и удержании первых сторонников.\nТрадиционные инвестиционные структуры часто медленные и закрытые, не давая возможности для участия сообществу.\nТокенизация меняет это, позволяя делиться долями, наградами или этапами развития в виде цифровых токенов, делая привлечение средств быстрее и доступнее.\nНаша цель — токенизировать ключевые этапы роста и доли стартапов, чтобы ранние сторонники получали реальную ценность, а основатели могли развиваться прозрачно.`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 order-1 lg:order-2 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Стартапы: новые возможности с токенами
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              Стартапы сталкиваются с трудностями в финансировании, прозрачности и масштабировании. Токенизация даёт сторонникам реальную ценность и помогает стартапам расти. Мы создаём токены для долей и этапов развития, чтобы ранние сторонники получали долю, а основатели масштабировались с поддержкой сообщества.
            </p>
