...
const CrowdFSection = () => {
  ...
  const fullText = `众筹为许多创意项目和初创企业打开了大门，让人们能够投资自己关心的想法。\n然而，传统众筹方式较为僵化——投资者往往流动性不足，贡献后也缺乏控制权。\n代币化让这些投资变成数字代币，更易于交易、追踪和管理。我们计划将众筹资产代币化，让支持者可以更灵活地持有、交易或增长投资，同时项目获得更好的长期支持。`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 transition-all duration-700 ${
            ...
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              众筹让社区能够支持项目，但传统方式缺乏流动性和灵活性。代币化将投资变成可追踪和交换的数字资产。我们为众筹项目创建代币，让投资者拥有更多灵活性和长期机会。
            </p>
