...
const TokenomicsSection = () => {
  ...
  const fullText = `Smart cities use technology, sensors, and data to make urban life more efficient—managing energy, traffic, and public services.\nBut coordinating millions of daily interactions and payments can be complex and costly.\nTokenization can help by turning these small actions—like using energy or sharing data—into tokens that streamline transactions and improve accountability.\nWe want to tokenize city services and IoT tasks, creating smarter, more connected urban economies that benefit both citizens and local governments.`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Simplifying Urban Life with Tokens
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              Smart cities use technology to improve urban life, but managing tasks like traffic and energy is complex. Tokenization turns tasks and services into digital tokens that are easy to manage and exchange. We create tokens for smart-city activities, helping cities run smoothly while encouraging participation from residents and businesses.
            </p>
