...
const TokenomicsSection = () => {
  ...
  const fullText = `Умные города используют технологии, датчики и данные для повышения эффективности городской жизни — управления энергией, транспортом и общественными услугами.\nНо координация миллионов ежедневных взаимодействий и платежей может быть сложной и затратной.\nТокенизация помогает, превращая такие действия, как использование энергии или обмен данными, в токены, которые упрощают транзакции и повышают прозрачность.\nМы хотим токенизировать городские сервисы и задачи IoT, создавая более умные и связанные городские экономики, выгодные для граждан и местных властей.`;
  ...
  return (
    <section ref={ref} id="tokenomics" className="py-12 sm:py-16 lg:py-24 xl:py-32 bg-muted">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className={`space-y-4 sm:space-y-6 lg:space-y-8 transition-all duration-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">
              Упрощаем городскую жизнь с помощью токенов
            </h2>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-foreground leading-relaxed">
              Умные города используют технологии для улучшения жизни, но управление такими задачами, как транспорт и энергия, сложно. Токенизация превращает задачи и сервисы в цифровые токены, которыми легко управлять и обмениваться. Мы создаём токены для городских активностей, помогая городам работать эффективнее и вовлекая жителей и бизнес.
            </p>
          ...
          <div className={`relative aspect-video bg-muted rounded-lg flex items-center justify-center w-full overflow-hidden transition-all duration-700 delay-300 ${
            ...
            <img 
              src="/SmartC.png" 
              alt="Smart city and tokenization illustration" 
